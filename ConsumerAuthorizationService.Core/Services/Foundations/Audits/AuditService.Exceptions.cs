    ...
    internal partial class AuditService
    {
        ...
        private async ValueTask<Audit> TryCatch(ReturningAuditFunction returningAuditFunction)
        {
            ...
            catch (ForeignKeyConstraintConflictException foreignKeyConstraintConflictException)
            {
                ...
                throw await CreateAndLogDependencyValidationExceptionAsync(invalidReferenceAuditException);
            }
            ...
            catch (DbUpdateException databaseUpdateException)
            {
                ...
                throw await CreateAndLogDependencyExceptionAsync(failedStorageAuditException);
            }
            catch (Exception exception)
            {
                ...
                throw await CreateAndLogServiceExceptionAsync(failedAuditException);
            }
        }
