...
namespace ConsumerAuthorizationService.Core.Brokers.Securities
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Applies audit values related to entity creation, such as CreatedBy and CreatedWhen,
        ...
        /// <summary>
        /// Applies audit values related to entity modification, such as UpdatedBy and UpdatedWhen,
        /// using the provided claims principal and security configuration.
        /// </summary>
        /// <typeparam name="T">The type of the entity being audited.</typeparam>
        /// <param name="entity">The entity to which audit values should be applied.</param>
        ...
        /// <summary>
        /// Applies audit values related to logical deletion, such as UpdatedBy and UpdatedWhen,
        /// using the provided claims principal and security configuration.
        /// </summary>
        /// <typeparam name="T">The type of the entity being audited.</typeparam>
