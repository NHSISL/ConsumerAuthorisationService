...
namespace ConsumerAuthorizationService.Manage.Tests.Acceptance.Brokers
{
    public partial class ApiBroker
    {
        ...
        public async ValueTask<List<FhirRecordDifference>> GetSpecificFhirRecordDifferenceByIdAsync(Guid fhirRecordDifferenceId) =>
            await this.apiFactoryClient.GetContentAsync<List<FhirRecordDifference>>(
                $"{fhirRecordDifferencesRelativeUrl}?$filter=Id eq {fhirRecordDifferenceId}");
        ...
        public async ValueTask<FhirRecordDifference> GetFhirRecordDifferenceByIdAsync(Guid fhirRecordDifferenceId) =>
            await this.apiFactoryClient
                .GetContentAsync<FhirRecordDifference>($"{fhirRecordDifferencesRelativeUrl}/{fhirRecordDifferenceId}");

        public async ValueTask<FhirRecordDifference> DeleteFhirRecordDifferenceByIdAsync(Guid fhirRecordDifferenceId) =>
            await this.apiFactoryClient
                .DeleteContentAsync<FhirRecordDifference>($"{fhirRecordDifferencesRelativeUrl}/{fhirRecordDifferenceId}");
